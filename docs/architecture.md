...
flowchart TD
    ...
    classDef preLlmGate fill:none,color:#fff,stroke:#ff9966,stroke-width:2px;
    classDef hitl fill:none,color:#fff,stroke:#99ccff,stroke-width:2px;
    classDef llmAgent fill:none,color:#fff,stroke:#b3ffb3,stroke-width:1px;
    classDef external fill:none,color:#fff,stroke:#cccccc,stroke-width:1px,stroke-dasharray: 5 5;
    classDef normalNode fill:none,color:#fff,stroke:#ffffff,stroke-width:1px;
